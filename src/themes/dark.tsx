...
import {
  ...
  TSpacings,
  TTheme,
} from '../definitions/types/ContextTheme';
...
const BUTTONS: TButtonColors = {
  DEFAULT: {
    color: TEXT_COLORS.light_gray,
    'background-color': color.opacity(COLORS.primary, 0.3),
    ':hover': {
      color: TEXT_COLORS.light_gray,
      'background-color': color.opacity(color.lighten(COLORS.primary), 0.5),
    },
    ':disabled': { 'background-color': color.fade(COLORS.primary) },
    active: { 'background-color': color.lighten(COLORS['bg-emerald-900']) },
  },
  primary: {
    color: TEXT_COLORS.white,
    'background-color': COLORS.primary,
    ':hover': { color: TEXT_COLORS.white, 'background-color': color.lighten(COLORS.primary) },
    ':disabled': { 'background-color': color.fade(COLORS.primary) },
    active: { 'background-color': color.lighten(COLORS.primary) },
  },
  light: {
    color: TEXT_COLORS.dark_gray,
    'background-color': color.opacity(COLORS.light_gray, 0.5),
    ':hover': {
      color: TEXT_COLORS.dark_gray,
      'background-color': color.opacity(color.lighten(COLORS.light_gray, 0.03), 0.5),
    },
    ':disabled': { 'background-color': color.fade(COLORS.light_gray) },
    active: { 'background-color': color.lighten(COLORS.light_gray) },
  },
  success: {
    color: TEXT_COLORS.white,
    'background-color': COLORS.success,
    ':hover': { color: TEXT_COLORS.white, 'background-color': color.lighten(COLORS.success) },
    ':disabled': { 'background-color': color.fade(COLORS.success) },
    active: { 'background-color': color.lighten(COLORS.success) },
  },
  danger: {
    color: TEXT_COLORS.white,
    'background-color': COLORS.danger,
    ':hover': { color: TEXT_COLORS.white, 'background-color': color.lighten(COLORS.danger) },
    ':disabled': { 'background-color': color.fade(COLORS.danger) },
    active: { 'background-color': color.lighten(COLORS.danger) },
  },
  secondary: {
    color: TEXT_COLORS.white,
    'background-color': COLORS.secondary,
    ':hover': { color: TEXT_COLORS.white, 'background-color': color.lighten(COLORS.secondary) },
    ':disabled': { 'background-color': color.fade(COLORS.secondary) },
    active: { 'background-color': color.lighten(COLORS.secondary) },
  },
  info: {
    color: TEXT_COLORS.white,
    'background-color': COLORS.info,
    ':hover': { color: TEXT_COLORS.white, 'background-color': color.lighten(COLORS.info) },
    ':disabled': { 'background-color': color.fade(COLORS.info) },
    active: { 'background-color': color.lighten(COLORS.info) },
  },
  link: {
    color: TEXT_COLORS.white,
    'background-color': COLORS.link,
    ':hover': { color: TEXT_COLORS.white, 'background-color': color.lighten(COLORS.link) },
    ':disabled': { 'background-color': color.fade(COLORS.link) },
  },
  warning: {
    color: TEXT_COLORS.white,
    'background-color': COLORS.warning,
    ':hover': { color: TEXT_COLORS.white, 'background-color': color.lighten(COLORS.warning) },
    ':disabled': { 'background-color': color.fade(COLORS.warning) },
    active: { 'background-color': color.lighten(COLORS.warning) },
  },
  transparent: {
    color: TEXT_COLORS.dark_gray,
    'background-color': 'transparent',
    ':hover': { color: TEXT_COLORS.dark_gray, 'background-color': COLORS.light_gray },
    ':disabled': { 'background-color': COLORS.light_gray },
    active: { 'background-color': '#ffffff10' },
  },
  login: {
    color: TEXT_COLORS.white,
    'background-color': COLORS.primary,
...
const BADGES: TBadgeColors = {
  ...
  transparent: {
    ...
    'background-color': 'transparent',
    ':disabled': { opacity: 0.6 },
    active: { 'background-color': '#ffffff12' },
  },
};

const CARDS: TCardColors = {
  DEFAULT: {
    color: TEXT_COLORS.dark_gray,
    'background-color': COLORS.bright_white,
...
export const dark: TTheme = {
  ...
  spacings: SPACINGS,
  drop_shadows: {
    sm: 'drop-shadow(0 1px 1px rgb(100 100 100 / 0.05))',
    DEFAULT: 'drop-shadow(0 1px 2px rgb(100 100 100 / 0.1)) drop-shadow(0 1px 1px rgb(100 100 100 / 0.06))',
    md: 'drop-shadow(0 4px 3px rgb(100 100 100 / 0.07)) drop-shadow(0 2px 2px rgb(100 100 100 / 0.06))',
    lg: 'drop-shadow(0 10px 8px rgb(100 100 100 / 0.04)) drop-shadow(0 4px 3px rgb(100 100 100 / 0.1))',
    xl: 'drop-shadow(0 20px 13px rgb(100 100 100 / 0.03)) drop-shadow(0 8px 5px rgb(100 100 100 / 0.08))',
    '2xl': 'drop-shadow(0 25px 25px rgb(100 100 100 / 0.15))',
  ...
  sidebar: {
    color: TEXT_COLORS.dark_gray,
    color_hover: TEXT_COLORS.primary,
  },
  card_colors: CARDS,
};

export const screens = {
  sm: (...args: FlattenSimpleInterpolation[]) => css`
    @media (min-width: ${DEFAULT.screens.sm}) {
      ${args};
    }
  `,
  md: (...args: FlattenSimpleInterpolation[]) => css`
    @media (min-width: ${DEFAULT.screens.md}) {
      ${args};
    }
  `,
  lg: (...args: FlattenSimpleInterpolation[]) => css`
    @media (min-width: ${DEFAULT.screens.lg}) {
      ${args};
    }
  `,
  xl: (...args: FlattenSimpleInterpolation[]) => css`
    @media (min-width: ${DEFAULT.screens.xl}) {
      ${args};
    }
  `,
  '2xl': (...args: FlattenSimpleInterpolation[]) => css`
    @media (min-width: ${DEFAULT.screens['2xl']}) {
      ${args};
    }
  `,
};
