...
const BUTTONS: TButtonColors = {
  DEFAULT: {
    ...
    ':hover': { color: COLORS.white, 'background-color': color.lighten(COLORS.primary) },
  ...
  light: {
    ...
    ':hover': {
      color: COLORS.dark_gray,
      'background-color': color.lighten(COLORS.light_gray, 0.03),
    },
  ...
  success: {
    ...
    ':hover': { color: COLORS.white, 'background-color': color.lighten(COLORS.success) },
  ...
  danger: {
    ...
    ':hover': { color: COLORS.white, 'background-color': color.lighten(COLORS.danger) },
  ...
  secondary: {
    ...
    ':hover': { color: COLORS.white, 'background-color': color.lighten(COLORS.secondary) },
  ...
  info: {
    ...
    ':hover': { color: COLORS.white, 'background-color': color.lighten(COLORS.info) },
  ...
  link: {
    ...
    ':hover': { color: COLORS.white, 'background-color': color.lighten(COLORS.link) },
    ':disabled': { 'background-color': color.fade(COLORS.link) },
  },
  warning: {
    color: COLORS.white,
    'background-color': COLORS.warning,
    ':hover': { color: COLORS.white, 'background-color': color.lighten(COLORS.warning) },
  ...
  transparent: {
    ...
    ':hover': { color: COLORS.dark_gray, 'background-color': COLORS.light_gray },
